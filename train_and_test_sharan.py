...
tpath = os.path.dirname(os.path.abspath("params.py"))
print(tpath)
...
if "data" in opt_exp and opt_exp.data == "rw_to_rw_atk":
    ...
    trainpath = ['media/datadisk/Roshan/datasets/data_coll_July22_2_ref/204/data123.mat']
...
#####################################Final Complex Space Results################################################
    ...
    trainpath = ['/datasets/dataset_non_fov_train_jacobs_July28_2.mat',
                '/datasets/dataset_fov_train_jacobs_July28_2.mat']
    # trainpath = ['/datasets/dataset_train_jacobs_July28.mat'
    # ,'/datasets/dataset_train_jacobs_July28_2.mat']
    testpath = ['/datasets/dataset_non_fov_test_jacobs_July28_2.mat',
                '/datasets/dataset_fov_test_jacobs_July28_2.mat']
    print('Real World to Real World experiments started')
...
# randlist = random.sample(range(0,8000), 1500)
# train_data_subset = torch.utils.data.Subset(train_data, randlist)
...
# test_data_subset = torch.utils.data.Subset(test_data, random.sample(range(0, 2000), 100))
