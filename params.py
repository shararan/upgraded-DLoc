...
opt_exp.input_shape = (8,16,21,46)
...
opt_exp.checkpoints_dir = join('/Results/sharan_regression_runs', opt_exp.save_name) # models are saved here
...
opt_encoder.lr = 3e-4 #type=float, default=0.0002, help='initial learning rate for adam')
